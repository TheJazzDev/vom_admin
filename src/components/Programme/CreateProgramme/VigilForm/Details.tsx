...
interface VigilDetailsProps {
  control: Control<VigilProgrammeProps>;
}

export default function VigilDetails({ control }: VigilDetailsProps) {
  return (
    <Card>
      <CardHeader>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Enter Vigil theme" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
