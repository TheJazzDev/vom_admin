...
import { usePastProgrammes } from "@/hooks/useProgrammes";
import { ProgrammeCard } from "../Components/ProgrammeCard";
import { ProgrammeListSkeleton } from "../Components/Skeletons/ProgrammeCardSkeleton";

const PastProgrammesPage = () => {
  const [searchTerm, setSearchTerm] = useState("");

  const { data: programmes, isLoading, error } = usePastProgrammes();
    ...
    <div className="space-y-8 py-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            View completed church programmes and services
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="flex-1 relative">
          ...
          <Input
            placeholder="Search past programmes..."
            className="pl-10"
            value={searchTerm}
          ...
          <CardContent className="p-6">
            <div className="text-center py-12">
              ...
              <p className="text-red-600 dark:text-red-400">
                {error.message || "Failed to load past programmes"}
              </p>
            </div>
          </CardContent>
        </Card>
...
export default PastProgrammesPage;
